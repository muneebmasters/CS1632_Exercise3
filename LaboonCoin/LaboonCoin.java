...
public class LaboonCoin {
    ...
    public String createBlock(String data, int prevHash, int nonce, int hash) {
        ...
        String paddedPrev = String.format("%08x", prevHash);
        String paddedNonce = String.format("%08x", nonce);
        String paddedHash = String.format("%08x", hash);
        String returnString = data + "|" + paddedPrev + "|" + paddedNonce + "|" + paddedHash;
    ...
    public String getBlockChain() {
        ...
        for (String blockString : blockchain)
        {
            returnString = returnString + System.lineSeparator() + blockString;
        }
